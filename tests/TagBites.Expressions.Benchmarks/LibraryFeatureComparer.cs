...
public static class LibraryFeatureComparer
{
    ...
    [
        ...
        ("`params` method call (`string.Format(\"{0}{1}\", 1, 2)`)", "string.Format(\"{0}{1}\", 1, 2)", "12"),
        ("Named arguments, reordered (`Substring(length: 2, startIndex: 1)`)", "\"abcdef\".Substring(length: 2, startIndex: 1)", "bc"),
        ("Indexers and index-from-end (`xs[^1]`)", "xs[^1]", "3"),
        ...
        ("Tuples with named elements", "(Name: \"Bob\", Age: 30).Name", "Bob"),
