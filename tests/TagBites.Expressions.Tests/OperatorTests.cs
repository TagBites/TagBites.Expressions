...
public class OperatorTests : ExpressionTestBase
{
    ...
    [InlineData("1 == 2 ? (int?)1 : null", null)]
    [InlineData("1 == 1 ? (int?)1 : null", 1)]
    [InlineData("1 == 2 ? null : (int?)1", 1)]
    [InlineData("1 == 1 ? null : (int?)1", null)]
    ...
    [InlineData("1 switch { 1 => 1, _ => null }")]
    ...
    [InlineData("((TypeCode?)TypeCode.Boolean) < 3", null)]
    [InlineData("((TypeCode?)TypeCode.Boolean) & 3", null)]
    [InlineData("TypeCode.Boolean == null", false)]
    [InlineData("TypeCode.Boolean != null", true)]
    [InlineData("TypeCode.Boolean > null", false)]
    [InlineData("null == TypeCode.Boolean", false)]
    [InlineData("(TypeCode.Boolean - null) == null", true)]
    [InlineData("(TypeCode.Boolean & null) == null", true)]
    [InlineData("((TypeCode?)TypeCode.Boolean) == null", false)]
    [InlineData("TypeCode.Boolean > 0", true)]
    [InlineData("TypeCode.Boolean >= 0", true)]
