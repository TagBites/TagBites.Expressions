...
|       TestCase        |        TagBites.Expressions<br>v. 1.4.0        |       DynamicExpresso<br>v. 2.19.3       |    System.Linq.Dynamic.Core<br>v. 1.7.3     |
| --------------------- | ---------------------------------------------: | ---------------------------------------: | ------------------------------------------: |
| Parse                 |  **`10,35 us`** (1,00x)<br>**5,92 KB** (1,00x) |   `33,45 us` (3,23x)<br>30,81 KB (5,21x) | `3305,38 us` (319,2x)<br>277,03 KB (46,83x) |
| Parse_SharedEnv       |   **`6,85 us`** (1,00x)<br>**3,02 KB** (1,00x) |   `19,61 us` (2,86x)<br>12,33 KB (4,09x) |   `85,38 us` (12,47x)<br>101,22 KB (33,56x) |
| ParseLambda           | **`91,61 us`** (1,00x)<br>**35,50 KB** (1,00x) | `307,14 us` (3,35x)<br>122,90 KB (3,46x) |  `3311,63 us` (36,15x)<br>207,69 KB (5,85x) |
| ParseLambda_SharedEnv | **`29,16 us`** (1,00x)<br>**11,57 KB** (1,00x) | `286,94 us` (9,84x)<br>104,08 KB (9,00x) |      `49,35 us` (1,69x)<br>35,26 KB (3,05x) |
