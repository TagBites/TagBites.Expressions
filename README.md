...
|       TestCase        |        TagBites.Expressions<br>v. 1.3.1        |       DynamicExpresso<br>v. 2.19.3       |    System.Linq.Dynamic.Core<br>v. 1.7.3     |
| --------------------- | ---------------------------------------------: | ---------------------------------------: | ------------------------------------------: |
| Parse                 |   **`5,65 us`** (1,00x)<br>**5,85 KB** (1,00x) |   `21,61 us` (3,83x)<br>30,75 KB (5,25x) | `3009,26 us` (532,8x)<br>276,86 KB (47,31x) |
| Parse_SharedEnv       |   **`3,81 us`** (1,00x)<br>**2,96 KB** (1,00x) |   `11,30 us` (2,97x)<br>12,33 KB (4,16x) |   `61,82 us` (16,24x)<br>100,96 KB (34,10x) |
| ParseLambda           | **`66,04 us`** (1,00x)<br>**35,35 KB** (1,00x) | `188,13 us` (2,85x)<br>122,75 KB (3,47x) |  `2990,92 us` (45,29x)<br>206,84 KB (5,85x) |
| ParseLambda_SharedEnv | **`20,06 us`** (1,00x)<br>**11,24 KB** (1,00x) | `170,51 us` (8,50x)<br>104,19 KB (9,27x) |      `32,13 us` (1,60x)<br>35,26 KB (3,14x) |
